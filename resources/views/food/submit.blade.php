            ...
            <section>
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                        <form method = "POST" class="form inputs-underline" action="{{url('food/store/'.$Id) }}" >
                        @csrf
                            <section>
                                <h3>Information</h3>
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"  id="price"  name="price" placeholder=" &#8358" min="0">
                                </div>
                                </div>
                                </div>
                                <!--end form-group-->
                            ...
                            <section class="center">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-rounded">Submit Food</button>
                                </div>
                                <!--end form-group-->
                            </section>
                        </form>
